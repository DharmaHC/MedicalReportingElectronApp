    ...
    if (
      ...
      try {
        ...
        if (response.ok) {
          ...
          navigate("/editor", { state: { htmlContent: data.html, readOnly, openedByOtherDoctor, requiresRtfEditor: data.requiresRtfEditor, savedRtfBase64: data.rtfBase64, templateTextAlign: data.templateTextAlign, templateBodyWidthPt: data.templateBodyWidthPt, templateBodyHeightPt: data.templateBodyHeightPt, templateLineSpacing: data.templateLineSpacing, templateSpacingAfterPt: data.templateSpacingAfterPt } });
        } else {
      ...
      try {
        ...
        if (response.ok) {
          const data = await response.json();
          navigate("/editor", { state: { htmlContent: data.html, readOnly, requiresRtfEditor: data.requiresRtfEditor, templateTextAlign: data.templateTextAlign, templateBodyWidthPt: data.templateBodyWidthPt, templateBodyHeightPt: data.templateBodyHeightPt, templateLineSpacing: data.templateLineSpacing, templateSpacingAfterPt: data.templateSpacingAfterPt } });
        } else {
